...
export default function ContactSection() {
  ...
  return (
    <>
      ...
      {/* Floating Social Buttons - Fixed to viewport */}
      <div className="fixed bottom-8 right-8 z-50 flex flex-col items-center gap-3">
        ...
        <motion.a
          ...
          className="w-14 h-14 rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(228,64,95,0.4)] hover:scale-110 transition-transform"
          style={{
            background:
        ...
        <motion.a
          ...
          className="w-14 h-14 bg-green rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(0,224,90,0.4)] hover:scale-110 transition-transform"
          data-cursor-hover
        >
